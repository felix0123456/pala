    ...
    <div class='card'>
      ...
      <form id='calendar-form' onsubmit='saveCalendar(event)' class='stack'>
        <div>
          ...
          <input type='text' name='cal_url' id='setting-cal-url' placeholder='https://calendar.google.com/calendar/ical/.../public/basic.ics'>
        </div>
        <div class='grid-2'>
          <div>
...
async function loadData() {
  ...
  try {
    ...
    if (data.calendarUrl !== undefined) {
      document.getElementById('setting-cal-url').value = data.calendarUrl;
    }
