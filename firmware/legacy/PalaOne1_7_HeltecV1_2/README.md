# PalaOne_Heltec (E-Reader Firmware v1.7.0)

## 1. Project Goals & Outline

_Ziele des Projekts sowie ein grober Überblick über den Aufbau._

- **Ziel:** Firmware für den PalaOne E-Reader auf Basis des Heltec Wireless Paper V1.2 (ESP32-S3), mit Spotify-Integration, Windows-Explorer Web-Dateiverwaltung, Multi-WiFi Profilen und Bluetooth-Konnektivitäts-Fixes.
- **Strukturübersicht:** Das Projekt enthält Firmware-Versionen für das Heltec Wireless Paper. Die neueste Version (v1.7.0) befindet sich in diesem Ordner (`PalaOne1_7_HeltecV1_2`).
...
- **C++:** 
  - [PalaOne1_7_HeltecV1_2.ino](file:///c:/Users/felix/Downloads/PalaOne1_5_HeltecV1_2/PalaOne1_7_HeltecV1_2/PalaOne1_7_HeltecV1_2.ino): Haupt-Sketch für die E-Reader-Firmware v1.7.0.
...
- **Flashing Instructions:** Flash über das PowerShell-Skript `flash.ps1` (mit Timeout-Timer) oder direkt mit `arduino-cli`.
  ...
  **Alternative Methode (manuell via arduino-cli):**
  ```bash
  # Compile v1.7.0
  arduino-cli compile --fqbn esp32:esp32:heltec_wireless_paper PalaOne1_7_HeltecV1_2.ino
  
  # Flash v1.7.0
  arduino-cli upload -p COM12 --fqbn esp32:esp32:heltec_wireless_paper PalaOne1_7_HeltecV1_2.ino
  ```
